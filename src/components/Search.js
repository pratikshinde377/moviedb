...
function Search(props) {
    ...
    const fetchLoadMore = async (page) => await BASE_API.get(`/search/movie?api_key=${API_KEY}&page=${page}&query=${name}`).then((response) => {
      ...
      return (<>
        <h1 className='offset-1'>Movies search for {name}</h1>
